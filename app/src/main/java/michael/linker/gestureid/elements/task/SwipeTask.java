package michael.linker.gestureid.elements.task;
...
import michael.linker.gestureid.config.ActivitiesBuildConfiguration;
import michael.linker.gestureid.elements.type.SwipeType;
