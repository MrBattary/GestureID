...
import michael.linker.gestureid.stream.manager.builder.output.IStreamManagerOutputFactoryBuilder;
import michael.linker.gestureid.stream.manager.builder.output.StreamManagerFileOutputFactoryBuilder;
import michael.linker.gestureid.stream.manager.builder.output.StreamManagerUiOutputFactoryBuilder;
