...
import michael.linker.gestureid.data.event.accumulator.overflow.strategy.EventAccumulatorFlushOldestStrategy;
import michael.linker.gestureid.data.event.accumulator.overflow.strategy.EventAccumulatorFlushStrategy;
import michael.linker.gestureid.data.event.accumulator.overflow.strategy.EventAccumulatorRaiseErrorStrategy;
